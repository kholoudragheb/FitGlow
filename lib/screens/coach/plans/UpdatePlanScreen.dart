...
import '../../../logic/cubits/update_plan/update_plan_cubit.dart';
...
class _UpdatePlanScreenState extends State<UpdatePlanScreen> {
  ...
  void initState() {
    ...
    _selectedDifficulty = widget.plan.difficulty;
    _selectedStatus = widget.plan.status;
    _durationWeeks = widget.plan.durationWeeks;
    _daysPerWeek = widget.plan.daysPerWeek;
  }
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      context.read<UpdatePlanCubit>().updatePlan(widget.plan.id, body);
    }
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => UpdatePlanCubit(PlanService()),
      child: BlocConsumer<UpdatePlanCubit, UpdatePlanState>(
        listener: (context, state) {
          ...
          } else if (state is UpdatePlanError) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
        ...
        builder: (context, state) {
          final isLoading = state is UpdatePlanLoading;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDropdown(
                      ...
                      items: ['active', 'paused', 'completed', 'archived'],
