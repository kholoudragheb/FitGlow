...
class _ClientLoginScreenState extends State<ClientLoginScreen> {
  ...
  Future<void> _handleLogin() async {
    print("Button clicked: Client Login");
    ...
    if (response.isSuccess) {
      if (response.accessToken != null && response.user != null) {
        ...
        if (response.user!.role.toLowerCase() == 'customer' || response.user!.role.toLowerCase() == 'client') {
          // Navigate to Client Home Screen / Dashboard
          Navigator.pushReplacementNamed(context, '/home');
        } else {
          _showError('This account does not have Customer privileges. Role: ${response.user!.role}');
        }
      } else {
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      ...
                      onPressed: () {
                        print("Button clicked: Toggle Password Visibility");
                        setState(() {
