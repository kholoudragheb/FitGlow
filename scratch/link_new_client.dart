...
void main() async {
  ...
  const coachProfileId = '6a089fffa16dea8dcb03cc38';

  print("\n=== STEP 2: Client sending Coach Request to correct profile ($coachProfileId) ===");
  final reqRes = await http.post(
    ...
    body: jsonEncode({
      ...
      'message': 'Hi Coach! I want to train with you.',
      'trainingType': 'online',
    }),
  );
